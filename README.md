...
<div style="max-width: 800px; margin: auto; line-height: 1.6;">
  <p align="center">
    I am an 18-year-old <strong>AI Solutions Engineer</strong> and <strong>Industrial Designer</strong> from Dagestan, Russia.
    I bridge the gap between physical hardware and intelligent software by building self-learning systems.
...
**VISAZH COSMETICS LLC** | *Makhachkala, Russia* | *2026 – Present*
*   **Role:** Implementing AI agents to automate e-commerce workflows and optimize internal business processes.
*   **Key Project:** Developing a **"Virtual Try-On"** AI agent using Computer Vision. The system analyzes user photos to visualize how specific cosmetic products would look on them, directly enhancing the customer shopping experience.

<br>

### **🚀 Founder & Lead Developer**
**Silver Clue** | *Makhachkala, Russia* | *2025*
*   **Mission:** Automating accounting in small and medium-sized businesses.
*   **Solution:** Created a Python pipeline (`Pandas`, `PyPDF2`) that analyzes unstructured bank checks and records data into structured tables.
*   **Impact:** Deployed in 3 companies, saving **300+ hours** of manual labor and **$1,400 USD** in monthly operating expenses per client.
...
<table width="100%">
  <tr>
    <td width="50%" valign="top">
      ...
      <p align="center">
        <a href="https://www.google.com/search?q=Hackathon+Winner"><img src="https://img.shields.io/badge/Status-Hackathon_Winner-gold" /></a>
        <br>
    ...
    <td width="50%" valign="top">
      ...
      <p align="center"><strong>IoT Child Safety Device</strong></p>
      <p>Wearable hardware with accelerometer/gyroscope sensors. Detects "danger zones" (windows/stairs) and sends Bluetooth alerts to a smartphone.</p>
      <p align="center">
...
| **2023** | 🥈 **Finalist** | **National "Professionals" Champ.** (Industrial Design - Ranked 7th in Russia). |
